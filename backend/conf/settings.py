...
RATE_LIMIT_TRUSTED_PROXIES = RATE_LIMIT_CONFIG.get(
    "trusted_proxies", _DEFAULT_RATE_LIMIT_CONFIG["trusted_proxies"]
)
RATE_LIMIT_RESPONSE = RATE_LIMIT_CONFIG.get(
    "response", _DEFAULT_RATE_LIMIT_CONFIG["response"]
)
...
TELEMETRY_ASYNC_BATCH_THRESHOLD = config(
    "TELEMETRY_ASYNC_BATCH_THRESHOLD", default="50", cast=int
)
