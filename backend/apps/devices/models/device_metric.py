...
class DeviceMetric(models.Model):
    ...
    device = models.ForeignKey('devices.Device', on_delete=models.CASCADE, null=False, db_index=True)
    metric = models.ForeignKey('devices.Metric', on_delete=models.RESTRICT, null=False, db_index=True)
