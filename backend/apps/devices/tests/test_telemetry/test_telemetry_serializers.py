...
def test_create_serializer_missing_required_field(valid_telemetry_payload, missing_field):
...
def test_create_serializer_metrics_rejects_invalid_metric_value_types(valid_telemetry_payload):
...
def test_batch_serializer_accepts_mixed_valid_and_invalid_items(valid_telemetry_payload):
